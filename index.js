...
//   let boxWidth = parseFloat(computedStyle.maxWidth)
//   let boxHeight = parseFloat(computedStyle.maxHeight)
//   for (let i = 0; i < newValue; i++) {
//     let column = document.createElement("div");
//     column.className = "column";
...
//       row.className = "row";
//       row.style.width = boxWidth/  input.value + "px";
//       row.style.height = boxHeight /   input.value + "px";
//       column.appendChild(row);
//     }
//     grid.appendChild(column);
//   }
